...
def save_urls():
    for i in range(38):
        url = "https://www.google.com.tw/search?q=guangzhou+Davos&tbm=nws&ei=XcMEW5HcAYLO8wXPsZmQAg&start=" + str(
            i * 10)
        html = get_html(url)
        get_urls(html)
        print('Page ', i + 1, 'done!')
...
def main():
    ...
    with open('data.json', 'r', encoding='utf-8') as f:
        try:
            with open('result2.json', 'a', encoding='utf-8') as f2:
                while True:
                    line = f.readline()
                    if line:
...
if __name__ == '__main__':
    ...
    # save_datas()
    main()
    # url = "https://webcache.googleusercontent.com/search?q=cache:https://www.cnbc.com/2017/06/18/china-reports-may-home-prices.html&num=1&hl=zh-CN&strip=1&vwsrc=0"
    # html = get_html(url)
